...
const bridge = {
  ...
  technicalPlan: {
    ...
    applyOutlineDeepening: (payload) => ipcRenderer.invoke('technical-plan:apply-outline-deepening', payload),
    setOutlineDeepWriting: (payload) => ipcRenderer.invoke('technical-plan:set-outline-deep-writing', payload),
  ...
  tasks: {
    ...
    startRequirementMatrixGeneration: (payload) => ipcRenderer.invoke('tasks:start-requirement-matrix-generation', payload),
    startOutlineGeneration: (payload) => ipcRenderer.invoke('tasks:start-outline-generation', payload),
    startOutlineDeepening: (payload) => ipcRenderer.invoke('tasks:start-outline-deepening', payload),
