...
const bridge = {
  ...
  technicalPlan: {
    ...
    confirmResponseTemplate: (payload) => ipcRenderer.invoke('technical-plan:confirm-response-template', payload),
    ...
    saveLockedTemplateValues: (payload) => ipcRenderer.invoke('technical-plan:save-locked-template-values', payload),
    saveFixedTableValues: (payload) => ipcRenderer.invoke('technical-plan:save-fixed-table-values', payload),
